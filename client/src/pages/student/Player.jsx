...
<>
  <div className='p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
    ...
    <div className='text-gray-800'>
      <h2 className='text-xl font-semibold'>Course Flow</h2>
      ...
      {playerData ? (
        <div className=''> 
          ...
          <div className='flex justify-between items-center mt-1'>
            ...
            <button onClick={() => markLectureAsCompleted(playerData.lectureId)} className='text-blue-800'>{progressData && progressData.lectureCompleted.includes(playerData.lectureId) ? 'Completed' : 'Mark Complete'}</button>
          </div>
        </div>
      )
      :
