    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p>{courseData.enrolledStudents.length} {courseData.enrolledStudents.length > 1 ? ' students' : 'student' }</p>
            ...
            <p className='text-sm '>Course By : <span className='text-blue-800 underline'>{courseData.educator.name}</span></p>
        ...
        <div className='py-20 text-sm md:text-default'>
          <h3 className='text-xl fone-semibold text-gray-800'>Course Description</h3>
      ...
      {/* right column */}
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-node overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center text-sm md:text-dafault gap-4 pt-2 md:pt-4 text-gray-500'>
                ...
                <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-800 text-white font-medium '
                >{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}</button>

                <div className='pt-6'>
                  <p className='md:text-xl text-lg font-medium text-gray-800'>What's you will get?</p>
