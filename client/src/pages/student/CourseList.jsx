          ...
          <div className='flex md:flex-row flex-col gap-6 items-start justify-between w-full'>
            ...
            <h1 className='text-4xl font-semibold text-gray-800'>Course List</h1>
              <p className='text-gray-500'> 
                <span className='text-blue-800 cursor-pointer' onClick={() => (navigate('/'))}>Home</span> / <span>Course List</span> 
              </p></div>
            <SearchBar data={input}/>
          </div>

        { input && <div className='inline-flex items-center gap-4 px-4 py-2 border mt-8 mb-8 text-gray-600 bg-white'> 
          <p>{input}</p>
